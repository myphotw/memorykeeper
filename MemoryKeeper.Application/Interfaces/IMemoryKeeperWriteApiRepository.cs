...
public interface IMemoryKeeperWriteApiRepository
{
    ...
    Task<MemoryKeeperTagCatalogListDto> GetTagCatalogAsync(string? query = null, CancellationToken cancellationToken = default);
    Task<MemoryKeeperTagCatalogItemDto> RenameCatalogTagAsync(string identity, MemoryKeeperTagCatalogRenameRequest request, CancellationToken cancellationToken = default);
    Task DeleteCatalogTagAsync(string identity, int expectedRevision, CancellationToken cancellationToken = default);
    ...
    Task<MemoryKeeperFileCatalogTagMutationResponse> RestoreFileCatalogTagAsync(string fileId, string identity, int expectedRevision, CancellationToken cancellationToken = default);
    Task<MemoryKeeperFileCatalogTagMutationResponse> HideFileCatalogTagAsync(string fileId, string identity, int expectedRevision, CancellationToken cancellationToken = default);
